...
class TCPModule(BaseModule):
    ...
    def analyze_tcp_connections(
        ...
        """
        CyberScanAI Analyze TCP connection states and lifecycle.

        CyberScanAI Tool perform TCP connection analysis with solving 80% of TCP-related issues.

        - Example: "PCAP_Files/tcp.pcap"
    ...
    def analyze_tcp_anomalies(
        ...
        """
        CyberScanAI Detect TCP traffic patterns through statistical analysis.

        CyberScanAI tool analyzes TCP traffic to identify observable patterns without
    ...
    def analyze_tcp_retransmissions(
        ...
        """
        CyberScanAI Analyze TCP retransmission patterns.
